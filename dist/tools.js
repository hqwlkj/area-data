(function (global, factory) {
    ...
    var tools = {
         ...
         * @returns {Array}
         */
        formatAreaData: function formatAreaData(data, parentId) {
            //51 ,0
            var options = [];
            for (var key in data) {
                if (parentId === '0' && data[key].id === '51') continue;
         ...
         * @returns {Array}
         */
        getProvinceCity: function getProvinceCity(data) {
         ...
         * @returns {Array}
         */
        getCountryProvinceCity: function getCountryProvinceCity(data) {
            var options = [];
            var option = {};
            option.value = '9999';
            option.label = '中国';
         ...
         * @returns {Array}
         */
        getProvincesAndCities: function getProvincesAndCities(data) {
            return this.formatAreaData(data, '0');
        },
        /**
         * 获取 国家 数据
         ...
         * @returns {Array}
         */
        getCountry: function getCountry(data) {
         ...
         * @returns {Array}
         */
        getCountryProvince: function getCountryProvince(data) {
            var options = [];
            var option = {};
            option.value = '9999';
            option.label = '中国';
